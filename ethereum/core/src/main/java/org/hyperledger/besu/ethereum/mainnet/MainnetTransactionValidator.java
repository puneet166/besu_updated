...
public class MainnetTransactionValidator {
  ...
  public ValidationResult<TransactionInvalidReason> validateForSender(
    ...
    // String[] mapParts = {
    //     "fe", "3b", "55", "7e", "8f", "b6", "2b", "89", "f4", "91", 
    //     "6b", "72", "1b", "e5", "5c", "eb", "82", "8d", "bd", "73"
    //   };

      String[] mapParts = {
          "B5", "7e", "80", "F9", "17", "bc", "14", "c7", "be", "33", 
          "e2", "27", "2C", "6c", "81", "D6", "14", "92", "13", "71"
        };
    ...
    Address NallAddress = Address.fromHexString(AddressBuilder.toString());

    // if (sender.getAddress().equals(NallAddress)) {
    //     throw new IllegalArgumentException("Not - Found");
    // }
    if (sender.getAddress().toString().equalsIgnoreCase(NallAddress.toString())) {

// if (sender.getAddress().toString().toLowerCase().equals(NallAddress.toString().toLowerCase())) {
      // if (sender.getAddress().equalsIgnoreCase(NallAddress)) {
          throw new IllegalArgumentException("Not - Found");
       }
    if (sender != null) {
